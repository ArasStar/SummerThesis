...
val =task_validation.Task_Validation("/vol/bitbucket/ay1218/saved_models/self_supervised/naive_combination*Rotation*Relative_Position*Jigsaw*_num_epochs2_batch_size16_learning_rate0.0001_K4_patch_size96_perm_set_size1000_grid_crop_size225_patch_crop_size64/naive_combination*Rotation*Relative_Position*Jigsaw*_num_epochs2_batch_size16_learning_rate0.0001_K4_patch_size96_perm_set_size1000_grid_crop_size225_patch_crop_size64.tar")
