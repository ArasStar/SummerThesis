...
print (aftertDT.strftime("%Y-%m-%d %H:%M:%S"))
print (aftertDT.strftime("%Y/%m/%d"))
print (aftertDT.strftime("%H:%M:%S"))
print (aftertDT.strftime("%I:%M:%S %p"))
print (aftertDT.strftime("%a, %b %d, %Y"))

c=aftertDT-currentDT

min,sec=divmod(c.days * 86400 + c.seconds, 60)
